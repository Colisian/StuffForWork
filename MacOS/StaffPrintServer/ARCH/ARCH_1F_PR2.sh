...
#      - Self Service: Add icon, display name "Install ARCH_1F_PR2"
...
# =============================================================================
PRINTER_NAME="ARCH_1F_PR2"
PRINTER_DESC="ARCH 1st Floor Printer 2"
PRINTER_LOC="Architecture Library, 1st Floor"
