...
#   - PRINTER_NAME    (e.g., "HBK_1F_PR2")
#   - PRINTER_DESC    (e.g., "Hornbake 1st Floor Printer 2")
#   - PRINTER_LOC     (e.g., "Hornbake Library, 1st Floor")
#
...
#      - Self Service: Add icon, display name "Install HBK_1F_PR2"
...
# =============================================================================
PRINTER_NAME="HBK_1F_PR2"
PRINTER_DESC="Hornbake 1st Floor Printer 2"
PRINTER_LOC="Hornbake Library, 1st Floor"
