...
Write-Outut "Starting Aeon Logon Script"

$destinationPath = "C:\Program Files (x86)\Aeon\AtlasHostingAE718_MDRM.dbc"
$sourceFolder = Join-Path -Path $PSScriptRoot -ChildPath "Files"
$filename = "AtlasHostingAE718_MDRM.dbc"
...
$valueData = "C:\Program Files (x86)\Aeon\AtlasHostingAE718_MDRM.dbc"
