...
function Get-PasswordDialog {
    ...
    $titleLabel.Text = "Ares ODBC Database Connection Setup"
    ...
    $label.Text = "Enter the AresLink database password:"
    $form.Controls.Add($label)

    # Help text
    $helpLabel = New-Object System.Windows.Forms.Label
    $helpLabel.Location = New-Object System.Drawing.Point(20, 75)
    $helpLabel.Size = New-Object System.Drawing.Size(360, 20)
    $helpLabel.Text = "(Contact RSR Head or lib-helpdesk@umd.edu for password)"
    $helpLabel.ForeColor = [System.Drawing.Color]::Gray
    $helpLabel.Font = New-Object System.Drawing.Font("Segoe UI", 8)
    ...
    $cancelButton.Location = New-Object System.Drawing.Point(285, 140)
...
if (-not $officeArch) {
    $warningResult = [System.Windows.Forms.MessageBox]::Show(
        "Could not detect Office installation.`n`nDefaulting to 32-bit Office configuration.`n`nContinue with 32-bit setup?",
        "Ares ODBC Setup - Warning",
...
"@
    [System.Windows.Forms.MessageBox]::Show(
        $errorMessage,
        "Ares ODBC Setup - Missing Driver",
        [System.Windows.Forms.MessageBoxButtons]::OK,
        [System.Windows.Forms.MessageBoxIcon]::Error
    )
    exit 1
...
"@
    [System.Windows.Forms.MessageBox]::Show(
        $errorMessage,
        "Ares ODBC Setup - Registry Error",
        [System.Windows.Forms.MessageBoxButtons]::OK,
        [System.Windows.Forms.MessageBoxIcon]::Error
    )
    exit 1
...
"@
    [System.Windows.Forms.MessageBox]::Show(
        $errorMessage,
        "Ares ODBC Setup - Configuration Error",
        [System.Windows.Forms.MessageBoxButtons]::OK,
        [System.Windows.Forms.MessageBoxIcon]::Error
    )
...
$successMessage = @"
Ares ODBC connection configured successfully!
