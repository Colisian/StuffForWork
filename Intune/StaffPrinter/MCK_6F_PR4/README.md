...
status: Ready
---
# MCK_6F_PR4 - Direct IP Printer (Intune Win32)
...
| Port | `IP_MCK_6F_PR4.resource.dyn.umd.edu` -> `MCK_6F_PR4.resource.dyn.umd.edu`:9100 (RAW) |
| Location | McKeldin - Graphics 6115 |
| Current print-server target | `10.204.152.27` |
...
```powershell
Get-Printer -Name 'MCK_6F_PR4' | Format-List Name, DriverName, PortName, Location
Get-PrinterPort -Name 'IP_MCK_6F_PR4.resource.dyn.umd.edu' | Format-List Name, PrinterHostAddress, PortNumber
Resolve-DnsName 'MCK_6F_PR4.resource.dyn.umd.edu'
Test-NetConnection 'MCK_6F_PR4.resource.dyn.umd.edu' -Port 9100
Get-Content 'C:\ProgramData\StaffPrinters\MCK_6F_PR4-Install.log' -Tail 30
```
