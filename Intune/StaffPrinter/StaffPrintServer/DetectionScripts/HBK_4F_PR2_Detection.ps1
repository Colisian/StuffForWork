<#
.SYNOPSIS
    Detection script for HBK_4F_PR2 printer (registry-based).

.DESCRIPTION
    Detects whether the HBK_4F_PR2 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: HBK_4F_PR2
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,HBK_4F_PR2
#>

$PrinterName   = "HBK_4F_PR2"
