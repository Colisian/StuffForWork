<#
.SYNOPSIS
    Detection script for ARCH_1F_PR2 printer (registry-based).

.DESCRIPTION
    Detects whether the ARCH_1F_PR2 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: ARCH_1F_PR2
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,ARCH_1F_PR2
#>

$PrinterName   = "ARCH_1F_PR2"
