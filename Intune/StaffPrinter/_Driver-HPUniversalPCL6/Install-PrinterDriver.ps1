<#
.SYNOPSIS
    Installs the HP Universal Printing PCL 6 printer driver machine-wide.
...
.PARAMETER DriverName
    Exact driver name from the INF [Models] section. Default: 'HP Universal Printing PCL 6'.
