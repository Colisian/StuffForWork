<#
.SYNOPSIS
    Detection script for PAL_2F_PR1 printer (registry-based).

.DESCRIPTION
    Detects whether the PAL_2F_PR1 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: PAL_2F_PR1
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,PAL_2F_PR1
#>

$PrinterName   = "PAL_2F_PR1"
