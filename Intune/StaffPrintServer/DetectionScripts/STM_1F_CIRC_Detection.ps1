<#
.SYNOPSIS
    Detection script for STM_1F_CIRC printer (registry-based).

.DESCRIPTION
    Detects whether the STM_1F_CIRC per-user printer connection exists by checking the
...
.NOTES
    Printer Name: STM_1F_CIRC
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,STM_1F_CIRC
#>

$PrinterName   = "STM_1F_CIRC"
