<#
.SYNOPSIS
    Detection script for HBK_1F_PR1 printer (registry-based).

.DESCRIPTION
    Detects whether the HBK_1F_PR1 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: HBK_1F_PR1
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,HBK_1F_PR1
#>

$PrinterName   = "HBK_1F_PR1"
