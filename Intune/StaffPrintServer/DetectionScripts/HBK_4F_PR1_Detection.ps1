<#
.SYNOPSIS
    Detection script for HBK_4F_PR1 printer (registry-based).

.DESCRIPTION
    Detects whether the HBK_4F_PR1 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: HBK_4F_PR1
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,HBK_4F_PR1
#>

$PrinterName   = "HBK_4F_PR1"
