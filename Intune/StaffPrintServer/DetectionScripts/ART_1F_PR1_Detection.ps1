<#
.SYNOPSIS
    Detection script for ART_1F_PR1 printer (registry-based).

.DESCRIPTION
    Detects whether the ART_1F_PR1 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: ART_1F_PR1
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,ART_1F_PR1
#>
