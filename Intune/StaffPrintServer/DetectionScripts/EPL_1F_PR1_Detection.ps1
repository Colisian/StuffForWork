<#
.SYNOPSIS
    Detection script for EPL_1F_PR1 printer (registry-based).

.DESCRIPTION
    Detects whether the EPL_1F_PR1 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: EPL_1F_PR1
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,EPL_1F_PR1
#>

$PrinterName   = "EPL_1F_PR1"
