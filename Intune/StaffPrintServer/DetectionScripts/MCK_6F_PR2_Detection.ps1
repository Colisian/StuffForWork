<#
.SYNOPSIS
    Detection script for MCK_6F_PR2 printer (registry-based).

.DESCRIPTION
    Detects whether the MCK_6F_PR2 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: MCK_6F_PR2
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,MCK_6F_PR2
#>

$PrinterName   = "MCK_6F_PR2"
