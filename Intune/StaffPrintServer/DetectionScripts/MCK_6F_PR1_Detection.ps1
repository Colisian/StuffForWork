<#
.SYNOPSIS
    Detection script for MCK_6F_PR1 printer (registry-based).

.DESCRIPTION
    Detects whether the MCK_6F_PR1 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: MCK_6F_PR1
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,MCK_6F_PR1
#>

$PrinterName   = "MCK_6F_PR1"
