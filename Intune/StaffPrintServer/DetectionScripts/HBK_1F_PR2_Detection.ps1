<#
.SYNOPSIS
    Detection script for HBK_1F_PR2 printer (registry-based).

.DESCRIPTION
    Detects whether the HBK_1F_PR2 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: HBK_1F_PR2
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,HBK_1F_PR2
#>
