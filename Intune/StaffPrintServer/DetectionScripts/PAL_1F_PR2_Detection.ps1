<#
.SYNOPSIS
    Detection script for PAL_1F_PR2 printer (registry-based).

.DESCRIPTION
    Detects whether the PAL_1F_PR2 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: PAL_1F_PR2
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,PAL_1F_PR2
#>

$PrinterName   = "PAL_1F_PR2"
