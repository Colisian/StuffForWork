<#
.SYNOPSIS
    Detection script for MCK_BF_PR5 printer (registry-based).

.DESCRIPTION
    Detects whether the MCK_BF_PR5 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: MCK_BF_PR5
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,MCK_BF_PR5
#>

$PrinterName   = "MCK_BF_PR5"
