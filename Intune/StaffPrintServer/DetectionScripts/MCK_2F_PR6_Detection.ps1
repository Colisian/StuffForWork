<#
.SYNOPSIS
    Detection script for MCK_2F_PR6 printer (registry-based).

.DESCRIPTION
    Detects whether the MCK_2F_PR6 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: MCK_2F_PR6
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,MCK_2F_PR6
#>

$PrinterName   = "MCK_2F_PR6"
