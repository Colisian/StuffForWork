<#
.SYNOPSIS
    Detection script for MCK_2F_PR2 printer (registry-based).

.DESCRIPTION
    Detects whether the MCK_2F_PR2 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: MCK_2F_PR2
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,MCK_2F_PR2
#>

$PrinterName   = "MCK_2F_PR2"
