<#
.SYNOPSIS
    Detection script for HBK_2F_PR3 printer (registry-based).

.DESCRIPTION
    Detects whether the HBK_2F_PR3 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: HBK_2F_PR3
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,HBK_2F_PR3
#>

$PrinterName   = "HBK_2F_PR3"
