<#
.SYNOPSIS
    Detection script for MCK_1F_PR4 printer (registry-based).

.DESCRIPTION
    Detects whether the MCK_1F_PR4 per-user printer connection exists by checking the
...
.NOTES
    Printer Name: MCK_1F_PR4
    Print Server: LIBRPS403v.ad.umd.edu
    Key checked:  <user hive>\Printers\Connections\,,LIBRPS403v.ad.umd.edu,MCK_1F_PR4
#>
